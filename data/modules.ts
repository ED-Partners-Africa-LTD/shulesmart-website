...
export const modules = [
  {
    ...
    image: "",
    content:
      "The Admissions module provides a clear and intuitive way to manage your entire school community with dedicated panels for Students, Classes, Teachers, Support Staff, Board Members, and Leave Outs, supported by simple list views for seamless navigation",
  },
  {
    name: "Finance",
    slug: "finance",
  ...
  },
  {
    ...
    image: "",
    content:
      "HR/Payroll module, provides a Dashboard for quick insights, Employee lists for organized records, Payrolls for monthly salary processing, Earnings and Deductions tracking, Statutory deductions management, leave monitoring, Advance/Loans processing, and Banks setup, ensuring accurate, transparent, and efficient HR and payroll management.",
  },
  {
    name: "Exam Analysis",
    slug: "exam",
