  ...
  return (
    ...
    >
      <style>{`
        ...
        h2 { font-size: 1.25rem; font-weight: 700; margin: 56px 0 16px; border-top: 1px solid #000; padding-top: 24px; }
        h3 { font-size: 1rem; font-weight: 700; margin: 32px 0 12px; }
        h4 { font-size: 0.95rem; font-weight: 700; margin: 24px 0 8px; }
        p  { font-size: 0.95rem; margin: 0 0 16px; }
        ul { padding-left: 20px; margin: 0 0 16px; }
        li { font-size: 0.95rem; margin-bottom: 8px; }
        li > ul { margin-top: 8px; }
        a  { color: #000; }
        .meta { font-size: 0.8rem; margin-bottom: 48px; border-bottom: 1px solid #000; padding-bottom: 24px; }
      `}</style>

      <h1>Privacy Policy</h1>
      <p className="meta">Last updated: May 14, 2026</p>
      ...
      <ul>
        ...
        <li>
          <strong>Application</strong> refers to ShuleSmart, the software
          program provided by the Company.
        </li>
        <li>
          <strong>Company</strong> (referred to as either "the Company", "We",
          "Us" or "Our" in this Privacy Policy) refers to Ed PartnersAfrica
          LTD, 4th Floor Parkfield Place, Muthangari Drive.
        </li>
        <li>
      ...
      <p>
        ...
        ("up to") and We may delete or anonymize data sooner when it is no
        longer needed for the relevant purpose. We apply different retention
        periods to different categories of Personal Data based on the purpose
      ...
      <ul>
        ...
        <li>
          <strong>Legal claims:</strong> Data is necessary to establish,
        ...
        <li>
          <strong>Technical limitations:</strong> Data exists in backup systems
      ...
      <ul>
        <li>
          <strong>Deletion:</strong> Personal Data is removed from Our systems
          and no longer actively processed.
        </li>
        <li>
          <strong>Backup retention:</strong> Residual copies may remain in
        ...
        <li>
          <strong>Anonymization:</strong> In some cases, We convert Personal
